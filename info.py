...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5915672876 5370676246').split()] 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003852794336').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003809630969'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003868558858'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003758118658'))  
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003892421187')) 
auth_grp = environ.get('AUTH_GROUP')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003786775251') 
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003742535868') 
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Cinezone270:Cinezone270@cluster0.vwgkzqo.mongodb.net/?appName=Cluster0")
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://Demo270:Demo270@cluster0.ls1igsg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_CHANGE_LIMIT = int(environ.get('DB_CHANGE_LIMIT', "375")) 

GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MovieUpGroup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MovieWorld303')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/apple_tuhin_11')
UPDATE_CHANNEL_LNK = environ.get('UPDATE_CHANNEL_LNK', 'https://t.me/+HmrSKKzRMmhhOWQ9')
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003792566846'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003700137904'))
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/HowtoDowlnoad/39")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/HowtoDowlnoad/39")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/HowtoDowlnoad/39")

SHORTENER_API = environ.get("SHORTENER_API", "38mxymohyqfidr3kfbewz0kflr9h2jf843ljdtrq")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "link-shotnear.vercel.app")

SHORTENER_API2 = environ.get("SHORTENER_API2", "38mxymohyqfidr3kfbewz0kflr9h2jf843ljdtrq")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "link-shotnear.vercel.app")

SHORTENER_API3 = environ.get("SHORTENER_API3", "38mxymohyqfidr3kfbewz0kflr9h2jf843ljdtrq")
